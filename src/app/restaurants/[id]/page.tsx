...
const RestaurantDetailsPage: React.FC<RestaurantDetailsPageProps> = ({ params }) => {
  const restaurants = [
    {
      id: 1,
      ...
      specialties: ["Homemade Pasta", "Wood-fired Pizza", "Tiramisu", "Wine Selection"],
      amenities: ["Outdoor Seating", "Private Dining", "Wine Cellar", "Valet Parking"],
      ...
      reservationPolicy: "Reservations recommended, especially for weekend dining",
    ...
    },
    {
      ...
      specialties: ["Fish & Chips", "Bangers & Mash", "Shepherd's Pie", "Craft Ales"],
      amenities: ["Live Music", "Sports Viewing", "Beer Garden", "Private Events"],
      address: "42 High Street, Camden, London NW1 7HB",
      phone: "+44 20 7123 4567",
      website: "www.jollytavern-london.co.uk",
      dietaryOptions: ["Vegetarian", "Gluten-Free"],
      reservationPolicy: "Walk-ins welcome, reservations accepted for groups of 6+",
      dresscode: "Casual"
    },
    {
      id: 3,
      ...
      specialties: ["Artisan Coffee", "Avocado Toast", "Quinoa Bowls", "Pastries"],
    ...
    },
    {
      ...
      specialties: ["Pad Thai", "Green Curry", "Tom Yum Soup", "Mango Sticky Rice"],
      amenities: ["Garden Seating", "Cultural Shows", "Private Rooms", "Cooking Classes"],
    ...
    },
    {
      ...
      specialties: ["Haggis", "Scottish Salmon", "Shortbread", "Whisky Selection"],
      amenities: ["Whisky Tasting", "Private Events", "Historic Tours", "Gift Shop"],
    ...
    },
    {
      ...
      specialties: ["Craft Burgers", "Artisan Steaks", "Farm Salads", "Craft Cocktails"],
    ...
    },
    {
      ...
      amenities: ["Ocean View", "Terrace Dining", "Wine Tasting", "Sunset Views"],
    ...
    },
    {
      ...
      image: "/Restaurants/restaurant-interior (1).jpg",
      cuisine: "French",
      rating: 4.7,
      reviews: 934,
      ...
      specialties: ["Coq au Vin", "Bouillabaisse", "Crème Brûlée", "French Wine"],
      amenities: ["Sidewalk Seating", "Wine Cave", "Private Dining", "Catering"],
    ...
    },
    {
      ...
      amenities: ["Vineyard Views", "Wine Tasting", "Cooking Classes", "Farm Tours"],
    ...
    },
    {
      ...
      specialties: ["Wine Pairings", "Seasonal Menu", "Local Produce", "Artisan Cheese"],
      amenities: ["Vineyard Views", "Wine Cellar", "Sommelier Service", "Private Events"],
    ...
    },
    {
      ...
      amenities: ["Traditional Music", "Hookah Lounge", "Cultural Events", "Takeaway"],
    ...
    return (
      <div style={{ backgroundColor: "#f8f9fa", minHeight: "100vh" }}>
        ...
        <div style={{ 
          ...
          <h1 style={{ fontSize: "2rem", color: "#333", marginBottom: "1rem" }}>Restaurant Not Found</h1>
  ...
  const getCuisineColor = (cuisine: string) => {
    switch (cuisine) {
      case 'Italian': return '#008000';
      case 'British Pub': return '#8B4513';
      case 'Modern European': return '#4682B4';
      case 'Thai': return '#FF6347';
      case 'Scottish': return '#800080';
      case 'American Fusion': return '#FF4500';
      case 'Mediterranean': return '#20B2AA';
      case 'French': return '#4169E1';
      case 'Tuscan': return '#228B22';
      case 'Californian': return '#DAA520';
      case 'Turkish': return '#DC143C';
          ...
          <div>
            <section style={{ marginBottom: "3rem" }}>
              ...
              <div style={{
                ...
                <div>
                  <span style={{ fontWeight: "600", color: "#333" }}>Atmosphere:</span>
                  <span style={{ marginLeft: "0.5rem", color: "#666" }}>{restaurant.atmosphere}</span>
                </div>
                <div>
                  <span style={{ fontWeight: "600", color: "#333" }}>Dress Code:</span>
                  <span style={{ marginLeft: "0.5rem", color: "#666" }}>{restaurant.dresscode}</span>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div style={{
                ...
                <div style={{ marginBottom: "1rem" }}>
                  ...
                  <p style={{ color: "#666", margin: "0.25rem 0 0 0" }}>{restaurant.address}</p>
                </div>
                <div style={{ marginBottom: "1rem" }}>
                  <strong style={{ color: "#333" }}>Phone:</strong>
                  <p style={{ color: "#666", margin: "0.25rem 0 0 0" }}>{restaurant.phone}</p>
                </div>
                <div style={{ marginBottom: "1rem" }}>
                  <strong style={{ color: "#333" }}>Website:</strong>
                  <p style={{ color: "#666", margin: "0.25rem 0 0 0" }}>{restaurant.website}</p>
                </div>
                <div>
                  <strong style={{ color: "#333" }}>Reservation Policy:</strong>
                  <p style={{ color: "#666", margin: "0.25rem 0 0 0" }}>{restaurant.reservationPolicy}</p>
                </div>
              </div>
            </section>
          </div>
          ...
          <div style={{ position: "sticky", top: "2rem" }}>
            <div style={{
              ...
              <div style={{
                ...
                <div>
                  <div style={{ fontWeight: "700", color: "#333", fontSize: "1.2rem" }}>{restaurant.rating}</div>
                  <div style={{ color: "#666", fontSize: "0.9rem" }}>{restaurant.reviews} reviews</div>
                </div>
              </div>
