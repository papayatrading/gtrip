...
const SpaDetailsPage: React.FC<SpaDetailsPageProps> = ({ params }) => {
  const spas = [
    {
      ...
      image: "/spa/arrangement-with-spa-stones-lit-candles.jpg",
      price: 120,
      originalPrice: 150,
      duration: "90 minutes",
      category: "Hot Stone",
      rating: 4.9,
      reviews: 456,
      treatments: ["Hot Stone Massage", "Aromatherapy", "Meditation", "Herbal Tea"],
      description: "Experience deep relaxation with heated volcanic stones and aromatic oils",
      ...
      amenities: ["Private Treatment Rooms", "Steam Room", "Relaxation Lounge", "Organic Tea Bar", "Garden Views"],
      therapists: ["Certified Massage Therapists", "Aromatherapy Specialists", "Meditation Guides"],
      packages: ["90-min Hot Stone", "2-hour Wellness Journey", "Half-day Retreat", "Couples Experience"],
    ...
    },
    {
      ...
      image: "/spa/attractive-african-woman-enjoying-face-massage-spa-salon.jpg",
      price: 85,
      originalPrice: 110,
      duration: "60 minutes",
      category: "Facial",
      rating: 4.8,
      reviews: 623,
      treatments: ["Deep Cleansing Facial", "Anti-aging Treatment", "Hydrating Mask", "Face Massage"],
      description: "Rejuvenate your skin with our signature facial treatments and premium skincare",
      ...
      amenities: ["Ocean View Rooms", "Premium Skincare Products", "Consultation Room", "Relaxation Terrace", "Refreshments"],
      therapists: ["Licensed Aestheticians", "Skincare Specialists", "Anti-aging Experts"],
      packages: ["Signature Facial", "Anti-aging Series", "Hydration Boost", "Bridal Package"],
    ...
    },
    {
      ...
      image: "/spa/close-up-man-relaxing-sauna.jpg",
      price: 65,
      originalPrice: 85,
      duration: "45 minutes",
      category: "Sauna",
      rating: 4.7,
      reviews: 342,
      treatments: ["Traditional Sauna", "Steam Bath", "Cold Plunge", "Relaxation Area"],
      description: "Authentic Finnish sauna experience with traditional heat therapy and cooling rituals",
      ...
      amenities: ["Traditional Wood Sauna", "Steam Room", "Cold Plunge Pool", "Rest Area", "Birch Branches"],
      therapists: ["Certified Sauna Masters", "Wellness Guides", "Traditional Healers"],
      packages: ["45-min Session", "2-hour Wellness", "Group Experience", "Private Sauna"],
    ...
    },
    {
      ...
      image: "/spa/man-getting-back-massage-with-oak-broom-bath-spa-hammam-russian-bathhouse-therapy.jpg",
      price: 95,
      originalPrice: 125,
      duration: "75 minutes",
      category: "Banya",
      rating: 4.6,
      reviews: 234,
      treatments: ["Oak Broom Massage", "Steam Room", "Traditional Banya", "Ice Bath"],
      description: "Traditional Russian banya experience with therapeutic oak branch treatments",
      ...
      amenities: ["Traditional Banya", "Oak Branch Therapy", "Ice Bath", "Steam Room", "Tea Service"],
      therapists: ["Banya Masters", "Traditional Healers", "Wellness Specialists"],
      packages: ["75-min Traditional", "Extended Banya", "Group Session", "Private Experience"],
    ...
    },
    {
      ...
      location: "Maldives",
      image: "/spa/modern-spa-massage-room-maldives-resort.jpg",
      price: 180,
      originalPrice: 220,
      ...
      rating: 5.0,
      reviews: 189,
      treatments: ["Ocean View Massage", "Couples Treatment", "Body Wrap", "Champagne Service"],
      description: "Ultimate luxury spa experience with panoramic ocean views and world-class treatments",
      ...
      amenities: ["Overwater Pavilions", "Ocean Views", "Private Cabanas", "Champagne Service", "Marine Spa Products"],
      therapists: ["Master Therapists", "Wellness Consultants", "Marine Therapy Specialists"],
      packages: ["2-hour Luxury", "Half-day Retreat", "Couples Paradise", "Sunset Experience"],
    ...
    },
    {
      ...
      image: "/spa/tender-african-woman-smiling-enjoying-massage-with-closed-eyes-spa-resort.jpg",
      price: 110,
      originalPrice: 140,
      duration: "90 minutes",
      ...
      rating: 4.8,
      reviews: 367,
      treatments: ["African Healing Massage", "Marula Oil Treatment", "Rooibos Wrap", "Sound Healing"],
      description: "Experience traditional African healing techniques with indigenous botanicals and therapies",
      ...
      amenities: ["Indigenous Plant Garden", "Traditional Healing Hut", "Sound Therapy Room", "Organic Products", "Cultural Experience"],
      therapists: ["Traditional Healers", "Certified Therapists", "Sound Healing Practitioners"],
      packages: ["90-min Healing", "Cultural Wellness", "Sound & Touch", "Sacred Plant Ceremony"],
    ...
    },
    {
      ...
      image: "/spa/woman-performs-tibetan-ritual-with-sound-bells-concept-therapy.jpg",
      price: 75,
      originalPrice: 100,
      duration: "60 minutes",
      ...
      rating: 4.9,
      reviews: 278,
      treatments: ["Singing Bowl Therapy", "Meditation", "Chakra Balancing", "Tibetan Massage"],
      description: "Harmonize your energy with ancient Tibetan sound healing and meditation practices",
      ...
      amenities: ["Sacred Sound Room", "Meditation Garden", "Prayer Flags", "Tibetan Instruments", "Mountain Views"],
      therapists: ["Tibetan Sound Masters", "Meditation Teachers", "Energy Healers"],
      packages: ["60-min Sound Healing", "Meditation Retreat", "Chakra Workshop", "Private Session"],
    ...
    },
    {
      ...
      image: "/spa/woman-tower-making-facial-mask-bathroom-photo.jpg",
      price: 140,
      originalPrice: 175,
      duration: "75 minutes",
      ...
      rating: 4.7,
      reviews: 445,
      treatments: ["Gold Facial", "Caviar Treatment", "LED Light Therapy", "Oxygen Infusion"],
      description: "Indulge in Parisian luxury with premium skincare treatments and cutting-edge technology",
      ...
      amenities: ["High-tech Treatment Rooms", "Premium French Products", "LED Light Therapy", "Oxygen Bar", "Champagne Lounge"],
      therapists: ["Master Aestheticians", "Technology Specialists", "French Beauty Experts"],
      packages: ["75-min Luxury Facial", "Gold Treatment Series", "Technology Package", "Bridal Beauty"],
    ...
    },
    {
      ...
      image: "/spa/woman-white-bathrobe-standing-bath-marble-rock.jpg",
      price: 160,
      originalPrice: 200,
      ...
      rating: 4.8,
      reviews: 234,
      treatments: ["Marble Stone Therapy", "Tuscan Olive Oil Massage", "Wine Bath", "Vineyard Views"],
      description: "Luxurious retreat in marble-clad sanctuary with organic Tuscan treatments and vineyard vistas",
      ...
      amenities: ["Marble Treatment Rooms", "Vineyard Views", "Organic Tuscan Products", "Wine Therapy", "Villa Gardens"],
      therapists: ["Italian Spa Masters", "Organic Treatment Specialists", "Wine Therapy Experts"],
      packages: ["105-min Retreat", "Wine & Wellness", "Tuscan Romance", "Vineyard Experience"],
    ...
    return (
      <div style={{ backgroundColor: "#f8f9fa", minHeight: "100vh" }}>
        ...
        <div style={{ 
          ...
          <h1 style={{ fontSize: "2rem", color: "#333", marginBottom: "1rem" }}>Spa Not Found</h1>
          <p style={{ color: "#666", marginBottom: "2rem" }}>The spa you're looking for doesn't exist.</p>
          <Link href="/spa" style={{ 
            background: "#FF385C", 
            color: "#fff", 
            textDecoration: "none", 
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      case 'Hot Stone': return '#8B4513';
      case 'Facial': return '#FFB6C1';
      case 'Sauna': return '#FF6347';
      case 'Banya': return '#4682B4';
      case 'Luxury': return '#DAA520';
      case 'Therapeutic': return '#228B22';
      case 'Sound Therapy': return '#9370DB';
      case 'Premium Facial': return '#FF69B4';
      case 'Luxury Retreat': return '#DC143C';
            ...
            <section style={{ marginBottom: "3rem" }}>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <span style={{ marginLeft: "0.5rem", color: "#666" }}>{spa.duration}</span>
                </div>
                <div>
                  <span style={{ fontWeight: "600", color: "#333" }}>Category:</span>
                  <span style={{ marginLeft: "0.5rem", color: "#666" }}>{spa.category}</span>
                </div>
              </div>
            </section>
              ...
              <div style={{
                ...
                {spa.packages.map((pkg, index) => (
                  <div key={index} style={{
                    ...
                    gap: "1rem",
                    padding: "0.75rem 0",
                    borderBottom: index < spa.packages.length - 1 ? "1px solid #eee" : "none"
                  }}>
                    <div style={{
                      width: "8px",
                      height: "8px",
            ...
            <section>
              ...
              <div style={{
                ...
                <div style={{ marginBottom: "1rem" }}>
                  ...
                  <p style={{ color: "#666", margin: "0.25rem 0 0 0" }}>{spa.address}</p>
                </div>
                <div style={{ marginBottom: "1rem" }}>
                  <strong style={{ color: "#333" }}>Phone:</strong>
                  <p style={{ color: "#666", margin: "0.25rem 0 0 0" }}>{spa.phone}</p>
                </div>
                <div style={{ marginBottom: "1.5rem" }}>
                  <strong style={{ color: "#333" }}>Website:</strong>
                  <p style={{ color: "#666", margin: "0.25rem 0 0 0" }}>{spa.website}</p>
                </div>
                <div style={{ borderTop: "1px solid #e0e0e0", paddingTop: "1rem" }}>
                  <strong style={{ color: "#333", display: "block", marginBottom: "0.5rem" }}>Policies:</strong>
                  {Object.entries(spa.policies).map(([key, value]) => (
                    <div key={key} style={{ marginBottom: "0.5rem" }}>
                      <span style={{ fontWeight: "500", color: "#555", textTransform: "capitalize" }}>
                        {key.replace(/([A-Z])/g, ' $1')}: 
                      </span>
                      <span style={{ color: "#666", marginLeft: "0.5rem" }}>{value}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div style={{ position: "sticky", top: "2rem" }}>
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ fontWeight: "600", color: "#333" }}>{spa.rating}</span>
              ...
              onMouseOver={(e) => e.currentTarget.style.background = "linear-gradient(135deg, #8A2BE2, #4B0082)"}
              onMouseOut={(e) => e.currentTarget.style.background = "linear-gradient(135deg, #9370DB, #663399)"}
              >
                Book Treatment
              </button>
