        ...
        >
          ...
          >
            ...
            <div style={{ position: "relative" }}>
              ...
              >
                ...
                <input
                  type="text"
                  placeholder={
                    sameLocation ? "Same location" : "City, airport..."
                  }
            ...
            <button
              ...
              onMouseOver={(e) =>
                (e.currentTarget.style.background = "#005999")
              }
            ...
            {[
              {
                ...
                rating: 5,
                review:
                  "Excellent car rental service! Clean vehicles, fair prices, and smooth pickup process. Highly recommend for road trips.",
                date: "5 days ago",
                avatar: "🚗",
              },
              {
                ...
                rating: 5,
                review:
                  "Great selection of cars and very competitive rates. The online booking was simple and the car was ready on time.",
                date: "1 week ago",
                avatar: "🚙",
              },
              {
                ...
                rating: 4,
                review:
                  "Good variety of rental options. The customer service was helpful and the car was in excellent condition throughout my trip.",
                date: "2 weeks ago",
                avatar: "🚕",
              },
            ].map((review, index) => (
